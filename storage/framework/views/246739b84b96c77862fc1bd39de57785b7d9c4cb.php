                ...
                <div class="carousel-box">
                    <div class="aiz-card-box border border-light rounded shadow-sm hov-shadow-md mb-2 has-transition bg-white">
                        <div class="position-relative">
                            <a href="<?php echo e(env('APP_URL') . 'products/'.$product->id.'/'. $product->slug); ?>" target="_blank" class="d-block">
                                <img
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Ecommerce4\resources\views/backend/dashboard.blade.php ENDPATH**/ ?>